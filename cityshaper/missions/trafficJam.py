...
def run():
   ...
   #zPivot.run(25, robot.motorB, light, robot.BACK_RIGHT, 70, 100)
   pidLineFollower.run(-8, robot.BACK_RIGHT, 1, distance, robot.motorB, 300, kp = 0.11)
   ...
   soundGenerator.beep()
   sleep(0.25)
   pidLineFollower.run(-15, robot.BACK_RIGHT, 1, distance, robot.motorB, 290)
   ...
   zMove.run(-40, 1, 1, distance, robot.motorB, 35)
   ...
   zMove.run(-100, 1, 1, distance, robot.motorB, 5000, startPower=90, kUp=150, kDown=0)
